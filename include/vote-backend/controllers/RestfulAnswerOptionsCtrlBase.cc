...
/**
 *
 *  RestfulAnswerOptionsCtrlBase.cc
...
void RestfulAnswerOptionsCtrlBase::getOne(const HttpRequestPtr &req,
                                          ...
                                          AnswerOptions::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<AnswerOptions> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [req, callbackPtr, this](AnswerOptions r) {
...
void RestfulAnswerOptionsCtrlBase::updateOne(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback,
                                             AnswerOptions::PrimaryKeyType &&id)
{
    ...
    try
    {
        if(isMasquerading())
        {
            if(!AnswerOptions::validateMasqueradedJsonForUpdate(*jsonPtr, masqueradingVector(), err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
        ...
        {
            if(!AnswerOptions::validateJsonForUpdate(*jsonPtr, err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
...
void RestfulAnswerOptionsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback,
                                             AnswerOptions::PrimaryKeyType &&id)
{
...
void RestfulAnswerOptionsCtrlBase::get(const HttpRequestPtr &req,
                                       std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<AnswerOptions> mapper(dbClientPtr);
    ...
    if(jsonPtr && jsonPtr->isMember("filter"))
    {
        try{
            ...
            mapper.findBy(criteria,
                [req, callbackPtr, this](const std::vector<AnswerOptions> &v) {
                    Json::Value ret;
                    ret.resize(0);
                    for (auto &obj : v)
                    {
    ...
    {
        mapper.findAll([req, callbackPtr, this](const std::vector<AnswerOptions> &v) {
                Json::Value ret;
                ret.resize(0);
                for (auto &obj : v)
                {
...
void RestfulAnswerOptionsCtrlBase::create(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    if(isMasquerading())
    {
        if(!AnswerOptions::validateMasqueradedJsonForCreation(*jsonPtr, masqueradingVector(), err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    {
        if(!AnswerOptions::validateJsonForCreation(*jsonPtr, err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    try 
    {
        AnswerOptions object = 
            (isMasquerading()? 
             AnswerOptions(*jsonPtr, masqueradingVector()) : 
             AnswerOptions(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [req, callbackPtr, this](AnswerOptions newObject){
...
/*
void RestfulAnswerOptionsCtrlBase::update(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

RestfulAnswerOptionsCtrlBase::RestfulAnswerOptionsCtrlBase()
    : RestfulController({
          "id",
          "question_id",
          "text"
