...
void RestfulUserAnswersCtrlBase::getOne(const HttpRequestPtr &req,
                                        ...
                                        UserAnswers::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<UserAnswers> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [req, callbackPtr, this](UserAnswers r) {
...
void RestfulUserAnswersCtrlBase::updateOne(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback,
                                           UserAnswers::PrimaryKeyType &&id)
{
    ...
    try
    {
        if(isMasquerading())
        {
            if(!UserAnswers::validateMasqueradedJsonForUpdate(*jsonPtr, masqueradingVector(), err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
        ...
        {
            if(!UserAnswers::validateJsonForUpdate(*jsonPtr, err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
...
void RestfulUserAnswersCtrlBase::deleteOne(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback,
                                           UserAnswers::PrimaryKeyType &&id)
{
...
void RestfulUserAnswersCtrlBase::get(const HttpRequestPtr &req,
                                     std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<UserAnswers> mapper(dbClientPtr);
    ...
    if(jsonPtr && jsonPtr->isMember("filter"))
    {
        try{
            ...
            mapper.findBy(criteria,
                [req, callbackPtr, this](const std::vector<UserAnswers> &v) {
                    Json::Value ret;
                    ret.resize(0);
                    for (auto &obj : v)
                    {
    ...
    {
        mapper.findAll([req, callbackPtr, this](const std::vector<UserAnswers> &v) {
                Json::Value ret;
                ret.resize(0);
                for (auto &obj : v)
                {
...
void RestfulUserAnswersCtrlBase::create(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    if(isMasquerading())
    {
        if(!UserAnswers::validateMasqueradedJsonForCreation(*jsonPtr, masqueradingVector(), err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    {
        if(!UserAnswers::validateJsonForCreation(*jsonPtr, err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    try 
    {
        UserAnswers object = 
            (isMasquerading()? 
             UserAnswers(*jsonPtr, masqueradingVector()) : 
             UserAnswers(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
        ...
        mapper.insert(
            object,
            [req, callbackPtr, this](UserAnswers newObject){
...
/*
void RestfulUserAnswersCtrlBase::update(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

RestfulUserAnswersCtrlBase::RestfulUserAnswersCtrlBase()
    : RestfulController({
          "id",
          "question_id",
          "answer_id",
      ...
      })
{
    ...
    */
    enableMasquerading({
        ...
        "question_id", // the alias for the question_id column.
        "answer_id", // the alias for the answer_id column.
