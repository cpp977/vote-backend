...
std::vector<Questions> Categories::getQuestions(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from questions where category_id = $1";
    Result r(nullptr);
    {
...
void Categories::getQuestions(const DbClientPtr &clientPtr,
