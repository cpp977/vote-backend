...
class Questions
{
  public:
     ...
     */
    explicit Questions(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Questions(const Json::Value &pJson) noexcept(false);
     ...
     */
    Questions(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column min_age  */
    ///Get the value of the column min_age, returns the default value if the column is null
    const int32_t &getValueOfMinAge() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getMinAge() const noexcept;
    ///Set the value of the column min_age
    void setMinAge(const int32_t &pMinAge) noexcept;
    ...
    Categories getCategory(const drogon::orm::DbClientPtr &clientPtr) const;
    void getCategory(const drogon::orm::DbClientPtr &clientPtr,
                     const std::function<void(Categories)> &rcb,
                     const drogon::orm::ExceptionCallback &ecb) const;
    Languages getLanguage(const drogon::orm::DbClientPtr &clientPtr) const;
    void getLanguage(const drogon::orm::DbClientPtr &clientPtr,
                     const std::function<void(Languages)> &rcb,
                     const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<AnswerOptions> getAnswerOptions(const drogon::orm::DbClientPtr &clientPtr) const;
    void getAnswerOptions(const drogon::orm::DbClientPtr &clientPtr,
                          const std::function<void(std::vector<AnswerOptions>)> &rcb,
                          const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<UserAnswers> getUserAnswers(const drogon::orm::DbClientPtr &clientPtr) const;
    void getUserAnswers(const drogon::orm::DbClientPtr &clientPtr,
                        const std::function<void(std::vector<UserAnswers>)> &rcb,
                        const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<Questions>;
    friend drogon::orm::BaseBuilder<Questions, true, true>;
    friend drogon::orm::BaseBuilder<Questions, true, false>;
    friend drogon::orm::BaseBuilder<Questions, false, true>;
    friend drogon::orm::BaseBuilder<Questions, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Questions>;
#endif
