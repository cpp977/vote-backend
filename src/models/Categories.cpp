...
const int64_t& Categories::getValueOfId() const noexcept {
  static const int64_t defaultValue = int64_t();
  if (id_) return *id_;
  return defaultValue;
}
const std::shared_ptr<int64_t>& Categories::getId() const noexcept {
  return id_;
}
void Categories::setId(const int64_t& pId) noexcept {
...
std::string Categories::toString() const { return toJson().toStyledString(); }
...
bool Categories::validateJsonForCreation(const Json::Value& pJson,
                                         std::string& err) {
  if (pJson.isMember("id")) {
...
bool Categories::validateJsonForUpdate(const Json::Value& pJson,
                                       std::string& err) {
  if (pJson.isMember("id")) {
...
bool Categories::validJsonOfField(size_t index, const std::string& fieldName,
...
std::vector<Questions> Categories::getQuestions(
